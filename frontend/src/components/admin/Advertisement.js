      ...
      <div className="grid grid-cols-1">
        <div className=" m-4 bg-[#b3ddff]  rounded-2xl">
          <div className="m-4 bg-white rounded-2xl">
            <h1 className="font-bold text-[30px] text-center">Advertisement</h1>
            <div className="flex flex-2 mt-4 pl-12 mb-4">
              <h1 className="font-semibold mr-5">Update the advertisement:</h1>
              <Button
                variant="contained"
                style={buttonStyle}
                className="mb-4"
            ...
            <div className="flex flex-2 pl-12 pb-6">
              <h1 className="font-semibold">About the advertisement:</h1>
              <input
                type="text"
                placeholder="About"
