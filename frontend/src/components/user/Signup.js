...
import DashHead from "../userlayouts/DashHead";
          ...
          <div className='border-[1px] border-dotted rounded-[10px] border-[black] w-2/6 "container p-5'>
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <div className="btn mt-2 flex justify-center">
                <button
                  className="text-[white] hover:scale-105 bg-black px-4 py-2  rounded-md tracking-wide   cursor-pointer transition ease-in duration-500 "
