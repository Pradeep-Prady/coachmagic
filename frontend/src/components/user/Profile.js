...
import avatar from "../../assets/img/Avatar Image.svg";
import { Link } from "react-router-dom";
import { Divider } from "@mui/material";
// import profiledet from "../Components/Tabs";
// import LabTabs from "../Components/Tabs";
// import wic from "../Assets/img/whatsapp-color-svgrepo-com.svg";
// import lic from "../Assets/img/link-circle-svgrepo-com.svg";
// import gic from "../Assets/img/gmail-svgrepo-com.svg";
import EditIcon from "@mui/icons-material/Edit";
// import profiledet from "../Components/Tabs";
import { FaShare } from "react-icons/fa";
import LabTabs from "../userlayouts/Tabs";
import { InputText } from "primereact/inputtext";
import bropic from "../../assets/img/bro-prof.png";
...
const Profile = () => {
  ...
  const [image2, setImage] = React.useState(avatar);
  ...
  return (
    <div className="  p-10">
      <div className=" bg-[#b3ddff] p-10 rounded-3xl flex">
        <div className=" bg-white flex rounded-3xl py-2">
          <div className=" flex flex-col bg-white   rounded-3xl  ">
            <div className="w-full flex  justify-end">
              <Link to='/settings' className="mx-5 font-semibold border-2 border-black text-xl px-3 py-1 flex items-center justify-center rounded-md">
                <EditIcon />
                <span>Edit</span>
              </Link>
            </div>
